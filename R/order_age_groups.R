#' order_age_groups
#'
#'Returns a suggested ordering of age groups. This is intended to serve as a guide only
#'and therefore code generated should be reviewed and modified as necessary.
#'Function is intended for use in creating visualisations ordered by age groups.
#'
#' @param y age group value
#'
#' @return
#' @export
#'
...
#'                 "50-54","75-79"))
#'
#'order_age_groups(data3$age_group)
#'
...
order_age_groups<-function(y){
  convert<-function(x){ #For a sinfular number
